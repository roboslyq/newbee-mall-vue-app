...
本仓库中的源码为广州资产AMC前后端分离版本的 Vue 项目（Vue 版本为 2.x），主要面向前端开发人员，后端 API 源码在另外一个仓库 [newbee-mall-api](https://github.com/newbee-ltd/newbee-mall-api)。

广州资产AMC Vue 版本线上预览地址：[http://vue-app.newbee.ltd](http://47.99.134.126:5000)，账号可自行注册，建议使用手机模式打开。

前后端分离版本包括四个仓库：

- [广州资产AMC后端接口 newbee-mall-api](https://github.com/newbee-ltd/newbee-mall-api)
- [广州资产AMC Vue2 版本 newbee-mall-vue-app](https://github.com/newbee-ltd/newbee-mall-vue-app)
- [广州资产AMC Vue3 版本 newbee-mall-vue3-app](https://github.com/newbee-ltd/newbee-mall-vue3-app)
- [广州资产AMC后台管理系统 Vue3 版本 vue3-admin](https://github.com/newbee-ltd/vue3-admin)
...
- [商城移动端开发实战-广州资产AMC底部导航(抽离公共组件)](https://juejin.im/book/6844733826191589390)
- [商城移动端开发实战-广州资产AMC登录注册页(前端鉴权)](https://juejin.im/book/6844733826191589390)
...
- [广州资产AMC迁移至 Vue 3.x 流程讲解](https://juejin.im/book/6844733826191589390)
